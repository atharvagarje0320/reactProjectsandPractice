    ...
    return (
        <div className="Header">
            ...
            <div className="app-logo-container">
                <img className="logo"
                    src="https://th.bing.com/th/id/OIP.auAN7PLBqelaX1xiGvdplAHaE8?w=243&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7.png" />
            </div>
            <div className="nav-items">
                <ul>
                    ...
                    <li>About</li>
                    <li>Contact</li>
                    <li><img src="https://i.pinimg.com/originals/f0/c0/83/f0c083d2beb2fd171d2b46fb408dd52b.jpg" style={{ width: "50px", marginBottom: "95px", borderRadius: "110px" }} /></li>
                </ul>
...
const ResCardComponent = (props) => {
    ...
    const { name, cuisines, costForTwoString, totalRatingsString } = resData?.data;  // Oonditional chaining & Adding the props.
    ...
    return (
        <div className="res-card" >
            ...
            <img style={{ width: "270px", height: "210px" }} src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" +
    ...
    return (
        <div className="Body">
            ...
            <div className="searchBar">
                <input placeholder="Search !!" style={{ height: "30px ", width: "1600px" }}></input>

            </div>
            <div className="Restaurant-Container">
                {
                    // resList.map(restaurant => <ResCardComponent resData={restaurant} />)  // Mapping the array


                    resList.map(restaurant => <ResCardComponent key={restaurant.data.id} resData={restaurant} />)
                }
            </div>
        </div>
    )
