  ...
  return (
    <div className="Body">
      <div className="searchBar">
        <input
          placeholder="Search !!"
          style={{ borderRadius: "20px", width: "1500px", height: "50px" }}
        ></input>
        <div className="search-icon">
          <button
            ...
            onClick={() => {
              const filteresd = listRestaurant.filter(
                (res) => res.data.rating > 4
              );

              setlistRestaurant(filteresd);
            }}
          >
            Search!!{" "}
          </button>
      ...
      <div className="Restaurant-Container">
        {
          ...
          listRestaurant.map((res) => (
            <ResCardComponent key={res.data.id} resData={res} />
          ))
        }
      </div>
    </div>
